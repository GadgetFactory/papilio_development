...
ENV_MAP = {
    ...
    'audio_pass_demo': 'libs/papilio_audio/examples/audio_pass_demo/audio_pass_demo.ino',
    'audio_mod_player': 'libs/papilio_audio/examples/audio_mod_player/audio_mod_player.ino',
}
